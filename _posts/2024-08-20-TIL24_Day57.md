...
We included max_iter=10000 as an extra parameter when creating the LogisticRegression object (which defaults to 1,000 iterations) to prevent convergence problems for smaller datasets or very high regularization parameter values. The code above generates the data plot chart shown below.

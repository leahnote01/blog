...
![19512157-FA95-4D8E-80C2-79A90503984F_1_105_c](/images/2024-11-04-TIL24_Day99_DL/19512157-FA95-4D8E-80C2-79A90503984F_1_105_c.jpeg)
...
- Training & Evaluation Strategy
  ...
  - General Recommendations
    ...
    - **Reserve minority data for evaluation of performance and picking an operating threshold for the model**
    - **Operating threshold**: The prediction score exceeds the threshold to establish the category.
  - Example
    - If all training data comes from a single hospital, significant distribution shift will occur.
...
- **Picking a Threshold**
  ...
  - AUC is the area under the curve, so we don't have to choose a threshold.
    ...
    ![image-20241218135536711](/images/2024-11-04-TIL24_Day99_DL/image-20241218135536711.png)
...
![image-20241219191041062](/images/2024-11-04-TIL24_Day99_DL/image-20241219191041062.png)

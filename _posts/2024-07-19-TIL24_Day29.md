...
First, we consider **odds** to explain the idea behind logistic regression as a probabilistic model for binary classification: the odds in favor of a particular event. 

...
# Practical Statistics of Data Scientists: A/B Testing, Hypothesis Tests, 
...
> Experimental design is fundamental to statistics, applicable in nearly all research fields. Its aim is **to create an experiment that either confirms or refutes a hypothesis.**
...
> Hypothesis tests, also known as *significance tests*, are common in the traditional statistical analysis of published research. They aim to help us understand whether random chance could account for an observed effect.
...
Hypothesis tests inherently involve not only a null hypothesis but also a corresponding alternative hypothesis. 

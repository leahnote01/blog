...
# Practical Statistics of Data Scientists: A/B Testing, Hypothesis Tests (One-Way & Two-Way), and Permutation Test
...
<center>
  <img src="../../images/2025-02-01-TIL25_Day114/image-20250215215648607.png" width="75%"><br><Br>
</center>



The boxplot indicates that Page B leads to longer session than page A. The means for each group can be computed as below.
...
Page B shows an average time that is 35.67 seconds longer than that of Page A. Therefore, the question arises as to whether this difference is within the range that random chance could produce, indicating statistical significance.

To answer this, we could use a permutation test: combining all the times together and then repeatedly shuffling and dividing them by the number of each page. 
...
- In Python
  ...
  <center>
    <img src="../../images/2025-02-01-TIL25_Day114/image-20250215220631512.png" width="75%"><br><br>
  </center>
...
<center>
  <img src="../../images/2025-02-01-TIL25_Day114/image-20250215225737301.png" width="75%">
</center>
...
This indicates that the noted difference in time between page A and page B falls well within the bounds of random variation and is therefore not statistically significant.

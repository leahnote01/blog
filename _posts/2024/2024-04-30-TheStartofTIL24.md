...
> In the summer of 2024, here in Rochester, I decided to dedicate **40 weekdays to writing one post every day**, making the most of the quiet and inspiring atmosphere of the library. My passion for learning and working on projects will guide every hour I spend there — preparing me for my journey as a Data Scientist and fueling my determination to achieve one of my greatest goals: **“To become a Data Scientist who makes a positive impact on the world.”**
...
May 1st, 2024 -- I was about to start a new chapter in my life—the beginning of my recording journey. However, this critical moment came with a lot of *frustration*. Even though I worked hard to find a summer internship, I faced many setbacks, making it to the final interview but then getting rejected. When the emails arrived in the morning, they hit me hard, revealing my weaknesses as a candidate. I struggled to effectively showcase my strengths and make a strong case for myself.
...
To enhance my interviewing skills, I need to build my confidence when discussing project methodologies and terminology. During interviews, I encountered several technical questions, which made it clear that I needed to grasp these concepts and communicate them in simple, relatable terms. This skill is vital for a data scientist, as collaboration with other departments often hinges on persuading them to develop business strategies based on data insights.
...
That's why I'm starting this project. I want to prepare myself to become a skilled storyteller and a data scientist/Machine Learning Engineer who understands the foundations, as it's gratifying to study them. I'm excited to apply my skills in the real business world!
...
### 🚀 I will write a post to explain what I've learned in simple terms, record the code, or summarize the key concepts.

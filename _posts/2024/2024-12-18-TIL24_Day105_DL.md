...
- Two primary types of changes to the data.<br><br>
  ...
  2. **Concept Drift ($P(Y \vert X)$):**
     ...
     - Three main categories <br><br>
       <center>
         <img src="/blog/images/2024-12-18-TIL24_Day105_DL/image-20250126163647316.png" width="50%"><br><br>
       </center>
...
1. **Stateless vs. Stateful Retraining**
   ...
   - **Stateful Retraining**
     ...
     - Image Source: [Sebastian Raschka - Machine Learning FAQ](https://sebastianraschka.com/faq/docs/stateless-stateful.html) <bR><br>
       <img src="/../images/2024-12-18-TIL24_Day105_DL/image-20250126202808793.png" alt="image-20250126202808793" style="zoom:50%;" />
     - Differences
...
- **Statistical Tests for Distribution Similarity**
  ...
  2. **Population Stability Index (PSI)**
     ...
     - Commonly used in *finance* to track changes in customer or trasaction data.<br>![image-20250126210703302](/../images/2024-12-18-TIL24_Day105_DL/image-20250126210703302.png)
...
![image-20250128150411559](/../images/2024-12-18-TIL24_Day105_DL/image-20250128150411559.png)

![image-20250128150654058](/../images/2024-12-18-TIL24_Day105_DL/image-20250128150654058.png)

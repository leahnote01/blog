---
title: "Day92 Deep Learning Lecture Review - HW2 Fine-Tuning Models (1)"
layout: single
classes: wide
categories: TIL_24
read_time: True
...
# Understanding of LoRA and Pre-trained Model Embeddings (ResNet+SBERT) for Visual Question Answering (VQA)

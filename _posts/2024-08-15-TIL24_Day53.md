...
Let's evaluate the performance of the `rbf_kernel_pca` method that we have implemented by following the steps below.
...
The two categories (circles and triangles) are <u>distinctly separated linearly</u>, which means we have an appropriate training dataset for linear classification.

![image-20240821185047922](/images/2024-08-15-TIL24_Day53/image-20240821185047922.png)

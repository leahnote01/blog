...
# Optimizing and Monitoring Hyperparameters with W&B and Conducting Pre-Training and Post Training (Dying ReLU)

<img src="/blog/images/2024-10-14-TIL24_Day91_DL/C38292DC-87CA-412E-BCEE-7415218C78CE_1_105_c.jpeg"><br><br>

In this latest assignment, I explored hyperparameter tuning, network fine-tuning, and monitoring model performance with Weights and Biases (W&B). The primary goal was to train ResNet-18 for image classification on the Oxford-IIIT Pet Dataset while optimizing different model parameters. Here’s a summary of my workflow, the results, and the insights I gained throughout the process.<br><br>

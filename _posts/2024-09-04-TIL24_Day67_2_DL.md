...
<center>
  <img src="/blog/images/2024-09-04-TIL24_Day67_2_DL/image-20240906192025570.png" width="70%"><br><br>
</center>
...
<center>
  <img src="/blog/images/2024-09-04-TIL24_Day67_2_DL/image-20240906192150804.png" width="70%"><br><br>
</center>
...
<center>
  <img src="/blog/images/2024-09-04-TIL24_Day67_2_DL/image-20240906170957740.png"><br><br>
</center>
...
<center>
  <img src="/blog/images/2024-09-04-TIL24_Day67_2_DL/image-20240906180257448.png"><br><br>
</center>
...
<center>
  <img src="/blog/images/2024-09-04-TIL24_Day67_2_DL/image-20240906192348056.png" width="80%"><br><br>
</center>



Let's consider a simpler example where we have an image input represented as a **5x5 matrix**. We also have a **3x3 filter** for our Convolutional Neural Network (CNN). Essentially, <u>this single filter scans the entire image input in order to find and process patterns</u>. The aim is to repetitively apply the same filter to all areas of our input image. When we apply this filter to the image, it performs a calculation using the <u>Inner Product</u> between matrices.
...
<center>
  <img src="/blog/images/2024-09-04-TIL24_Day67_2_DL/image-20240906192545116.png" width="70%"><br><br>
</center>
...
<center>
  ...
  <I>Left: Stride=1 / Right: Stride=2 </I><br><br>
</center>
...
<center>
  ...
  <I>Left: Zero-padding is not applied / Right: Zero-padding is applied</I>
</center>
...
The flatten layer serves as a critical component that transitions the high-dimensional <u>output of convolutional and pooling layers into a format suitable for traditional fully connected layers</u> (also known as dense layers).

For example, after several convolution and pooling operations, an image might be represented as a 12x12x32 volume (12x12 spatial dimensions and 32 channels). The flatten layer takes this 12x12x32 volume and converts it <u>into a single long vector of features.</u> This results in a vector of size 4,608 (which is 12 multiplied by 12 multiplied by 32).



#### Fully-Connected Layer (Dense Layer)

Now, finally, apply one or more fully connected layers and <u>then apply the softmax activation function to output the final result.</u>

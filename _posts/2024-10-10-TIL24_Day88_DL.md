...
- **Solutions** to Address Bus Bottlenecks:
  - <u>Increasing Bus Bandwidth</u>: Upgrading to buses with higher bandwidth can reduce bottlenecks. For example, **PCIe (Peripheral Component Interconnect Express), instead of older bus technologies like PCI or AGP, can drastically improve component data transfer rates.

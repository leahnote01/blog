...
<center>
  ...
  <I><font size="3pt">Image from (https://rasbt.github.io/mlxtend/user_guide/classifier/EnsembleVoteClassifier/)</font></I><br><br>
</center>
...
To predict a class label through simple majority or plurality voting, we combine the predicted class labels of each individual classifier, $C_j$, and select the class label, $\hat{y}$, with the most votes.
